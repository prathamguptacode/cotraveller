...
import { Mail, MessagesSquare, SendHorizontal, Cog, LogOut, ChevronDown, Info } from 'lucide-react'
...
const Chats = () => {
    ...
    useEffect(() => {
        ...
        if (isMounted || messages.length == 0 || !div) return
    ...
    // const openGroupOptions = async (groupId: string) => {
